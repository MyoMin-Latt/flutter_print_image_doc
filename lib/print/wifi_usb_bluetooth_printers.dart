...
// import 'image_utils.dart'; // PosStyles

// class ConnectBluetoothPrinter extends StatefulWidget {
//   const ConnectBluetoothPrinter({Key? key}) : super(key: key);

//   @override
//   State<ConnectBluetoothPrinter> createState() =>
//       _ConnectBluetoothPrinterState();
// }

// class _ConnectBluetoothPrinterState extends State<ConnectBluetoothPrinter> {
...
//   Widget myanmarTest() => RepaintBoundary(
//         key: globalKey,
//         child: const Column(
...
//             Center(
//               child: Text(
//                 'သောကကင်းစေ... မိုးစက်ရေ...',
//                 style: TextStyle(fontWeight: FontWeight.bold),
//               ),
//             ),
//             Text(
//               "အမှတ် (၅)၊ ရန်ကုန် အင်းစိန်လမ်းမ၊ ပါရမီမီးပွိင့်အနီး။",
...
//     final ui.Image image = await boundary.toImage(pixelRatio: 1.32);
...
//     return Scaffold(
//       appBar: AppBar(
//         title: const Text('Flutter Print'),
//       ),
//       body: Center(
//         child: Container(
